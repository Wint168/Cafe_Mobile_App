...
public class BubbleTeaMenu extends AppCompatActivity{

    private TextView bobaTitle;

    private ImageView bobaImage;

    private GridLayout bobaContainer;

    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.bubble_tea_menu);

        bobaTitle = findViewById(R.id.bobaTitle);
        bobaImage = findViewById(R.id.bobaImage);
        bobaContainer = findViewById(R.id.bobaContainer);
        ...
        bottomNav.setOnItemSelectedListener(item -> {
            ...
            if (id == R.id.home) {
                startActivity(new Intent(BubbleTeaMenu.this, frontpage.class));
                finish();
                return true;
            } else if (id == R.id.equipment) {
                startActivity(new Intent(BubbleTeaMenu.this, BubbleTeaEquipments.class));
                return true;
    ...
    private void fetchBobaMenu(){
        String url = SupabaseConnector.BASE_URL +
                "/rest/v1/drink_menu?select=drink_name,drink_photo,drink_types!inner(name)&drink_types.name=eq.Bubble Tea";
                ...
                runOnUiThread(() -> {
                    try {
                        ...
                        for (int i = 0; i < array.length(); i++) {
                            ...
                            LinearLayout box = new LinearLayout(BubbleTeaMenu.this);
                            box.setOrientation(LinearLayout.VERTICAL);
                            box.setBackgroundColor(ContextCompat.getColor(BubbleTeaMenu.this, R.color.bobadark));
                            ...
                            // Image
                            ImageView imageView = new ImageView(BubbleTeaMenu.this);
                            ...
                            // Name
                            TextView nameView = new TextView(BubbleTeaMenu.this);
                            nameView.setText(name);
                            nameView.setTextColor(ContextCompat.getColor(BubbleTeaMenu.this, R.color.white));
                            ...
                            box.setOnClickListener(v -> {
                                Intent intent = new Intent(BubbleTeaMenu.this, BubbleTeaRecipe.class);
